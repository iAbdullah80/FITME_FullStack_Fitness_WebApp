...
exports.adminDashboard = async (req, res) => {
  ...
  const item = await FoodItem.aggregate([{ $sort: { updatedAt: 1 } }])
  const locals = {
...
exports.addItemPost = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: 'Internal Server Error, could not add item' })
  }
}
...
exports.editItemPut = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: 'Internal Server Error, could not update item' })
  }
}
...
exports.deleteItem = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Internal Server Error, could not delete item' })
  }
}
